      ...
      integer, dimension(0:31) :: kb, mb, extra
      write(*,1003)
      ...
      call compress(message,extra,32)
      write(*,1007) (extra(i),i=0, 31)
      d=1
      call lucifer(d,k,m)
...
1007  format(1x,32z1.1)
      ...
      implicit none
!     Declare Calling paramater types and definitions
      integer, intent(inout), dimension(0:*) :: a, b
      integer, intent(in) :: l
      integer :: i, j, v
      do i = 0,l-1,1
          v=b(i)
...
!     Declare Calling paramater types and definitions
      ...
      integer, intent(inout), dimension(0:7,0:15) :: k
      integer, intent(in) :: d
